...
namespace BeerC0d3.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230513002148_ContextSupportCreate")]
    partial class ContextSupportCreate
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("chatGPT")
                .HasAnnotation("ProductVersion", "6.0.10")
                .HasAnnotation("Relational:MaxIdentifierLength", 128);

            SqlServerModelBuilderExtensions.UseIdentityColumns(modelBuilder, 1L, 1);

            modelBuilder.Entity("BeerC0d3.Core.Entities.chatGPT.ContextSupport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("modifitationDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("ContextSupport", "chatGPT");
                });

            modelBuilder.Entity("BeerC0d3.Core.Entities.chatGPT.Persona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
